...
`],encapsulation:2,changeDetection:0})}return n})();var se=(()=>{class n{static \u0275fac=function(t){return new(t||n)};static \u0275mod=k({type:n});static \u0275inj=x({imports:[J]})}return n})();var g=class n{i18n=a(oe);static \u0275fac=function(e){return new(e||n)};static \u0275cmp=h({type:n,selectors:[["app-root"]],decls:22,vars:3,consts:[[1,"app-shell"],[1,"app-toolbar"],["routerLink","/cv",1,"flex","items-center","gap-2","no-underline"],["src","logo.png","alt","FlexCV",1,"app-logo"],[1,"font-semibold"],[1,"toolbar-spacer"],[1,"flex","items-center","gap-1"],["matButton","","routerLink","/cv","routerLinkActive","toolbar-link-active"],["matButton","","routerLink","/ai","routerLinkActive","toolbar-link-active"],["matButton","","routerLink","/settings","routerLinkActive","toolbar-link-active"],[1,"app-content"]],template:function(e,t){e&1&&(d(0,"div",0)(1,"mat-toolbar",1)(2,"a",2),u(3,"img",3),d(4,"span",4),m(5,"FlexCV"),s()(),u(6,"span",5),d(7,"nav",6)(8,"a",7)(9,"mat-icon"),m(10,"description"),s(),m(11),s(),d(12,"a",8)(13,"mat-icon"),m(14,"forum"),s(),m(15),s(),d(16,"a",9)(17,"mat-icon"),m(18,"settings"),s(),m(19),s()()(),d(20,"main",10),u(21,"router-outlet"),s()()),e&2&&(p(11),f(" ",t.i18n.t("nav.cv")," "),p(4),f(" ",t.i18n.t("nav.chat")," "),p(4),f(" ",t.i18n.t("nav.settings")," "))},dependencies:[G,W,Y,se,le,$,K,te,ee],encapsulation:2,changeDetection:0})};Q(g,ie).catch(n=>console.error(n));
