...
export const en = {
  ...
  'cv.share.urlHint': 'You can also open a CV from a public JSON URL by adding ?cv=<url> to the address.',
...
export const uk: Record<TranslationKey, string> = {
  ...
  'cv.share.urlHint': 'Також можна відкрити CV за публічним URL на JSON, додавши ?cv=<url> до адреси.',
